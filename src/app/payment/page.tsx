  ...
  return (
    <div style={{ background: '#f9fafb', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '1.5rem' }}>
        <Link href="/payment/list" style={{ textDecoration: 'none' }}>
          <div style={{ background: 'white', border: '1.5px solid #f3f4f6', borderRadius: '1rem', padding: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.875rem', boxShadow: '0 1px 3px rgba(0,0,0,.05)', marginBottom: '0.75rem' }}>
            <div style={{ fontSize: '1.75rem' }}>💰</div>
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 700, fontSize: '0.9rem', color: '#111827' }}>납부 관리</div>
              <div style={{ fontSize: '0.75rem', color: '#9ca3af', marginTop: '2px' }}>납부 현황 확인 및 상태 변경</div>
            </div>
